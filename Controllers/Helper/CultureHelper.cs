...
namespace TableReservation.Controllers.Helpers
{
    public static class CultureHelper
    {
        ...
        private static readonly List<string> _cultures = new List<string> { "el", "en", "fr", "ru", "de" };
        ...
        public static string GetImplementedCulture(string name)
        {
            ...
            {
                if (c.Equals(n, StringComparison.InvariantCultureIgnoreCase))
                {
                    return c;
                }
        ...
        public static bool CurrentCultureIsRighToLeft()
        {
